...
export function BackgroundLayerContact() {
  return (
    <div className="fixed inset-0 z-0 overflow-hidden pointer-events-none bg-background-light dark:bg-[#0B0F15] transition-colors duration-300">
      ...
      <div className="absolute top-[-5%] left-[-5%] w-[600px] h-[600px] opacity-[0.04] dark:opacity-[0.06] pointer-events-none rotate-45">
        <svg
      ...
      <div className="absolute bottom-[-10%] right-[-5%] w-[800px] h-[800px] opacity-[0.03] dark:opacity-[0.05] pointer-events-none -rotate-12">
        <svg
          className="w-full h-full text-primary dark:text-white"
          fill="currentColor"
          viewBox="0 0 200 200"
